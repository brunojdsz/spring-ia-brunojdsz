...
import br.com.brunojdsz.service.TranscriptionService;
...
public class TranscriptionController {
    ...
    public ResponseEntity<String> transcribeAudio(@RequestParam("file")MultipartFile file) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error processing the audio file: "+ e.getMessage());
        }
    }
}
